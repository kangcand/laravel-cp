    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide" style="background-image: url('assets/frontend/img/post-slide-1.jpg');">
                    <div class="content">
                ...
                <div class="swiper-slide" style="background-image: url('assets/frontend/img/post-slide-2.jpg');">
                    <div class="content">
                ...
                <div class="swiper-slide" style="background-image: url('assets/frontend/img/post-slide-3.jpg');">
                    <div class="content">
                ...
                <div class="swiper-slide" style="background-image: url('assets/frontend/img/post-slide-4.jpg');">
                    <div class="content">
            ...
            <div class="row g-5">
                <div class="col-lg-4">
                    ...
                    <div class="post-entry lg">
                        <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-1.jpg')}}"
            ...
            <div class="col-md-9">
                ...
                <div class="d-lg-flex post-entry">
                    <a href="blog-details.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                        <img src="{{asset('assets/frontend/img/post-landscape-6.jpg')}}" alt="" class="img-fluid">
                    </a>
                    <div>
                        <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">•</span>
                            <span>Jul 5th '22</span>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="post-list">
                            <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-2.jpg')}}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">•</span>
                                <span>Jul 5th '22</span>
                            </div>
            ...
            <div class="col-md-9 order-md-2">
                ...
                <div class="d-lg-flex post-entry">
                    <a href="blog-details.html" class="me-4 thumbnail d-inline-block mb-4 mb-lg-0">
                        <img src="{{asset('assets/frontend/img/post-landscape-3.jpg')}}" alt="" class="img-fluid">
                    </a>
                    <div>
                        <div class="post-meta"><span class="date">Business</span> <span class="mx-1">•</span>
                            <span>Jul 5th '22</span>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="post-list border-bottom">
                            <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-5.jpg')}}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">Business</span> <span class="mx-1">•</span>
                                <span>Jul 5th '22</span></div>
                            <h2 class="mb-2"><a href="blog-details.html">11 Work From Home Part-Time Jobs You
                    ...
                    <div class="col-lg-8">
                        <div class="post-list">
                            <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-7.jpg')}}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">Business</span> <span class="mx-1">•</span>
                                <span>Jul 5th '22</span></div>
                            <h2 class="mb-2"><a href="blog-details.html">How to Avoid Distraction and Stay
        ...
        <div class="row g-5">
            <div class="col-lg-4">
                <div class="post-list lg">
                    <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-8.jpg')}}" alt=""
                            class="img-fluid"></a>
            ...
            <div class="col-lg-8">
                <div class="row g-5">
                    <div class="col-lg-4 border-start custom-border">
                        <div class="post-list">
                            <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-6.jpg')}}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">•</span>
                                <span>Jul 5th '22</span></div>
                            <h2><a href="blog-details.html">Let’s Get Back to Work, New York</a></h2>
                        ...
                        <div class="post-list">
                            <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-4.jpg')}}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">•</span>
                                <span>Mar 15th '22</span></div>
                    ...
                    <div class="col-lg-4 border-start custom-border">
                        <div class="post-list">
                            <a href="blog-details.html"><img src="{{asset('assets/frontend/img/post-landscape-3.jpg')}}"
                                    alt="" class="img-fluid"></a>
                            <div class="post-meta"><span class="date">Lifestyle</span> <span class="mx-1">•</span>
                                <span>Jul 5th '22</span></div>
                            <h2><a href="blog-details.html">6 Easy Steps To Create Your Own Cute Merch For
